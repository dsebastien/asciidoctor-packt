...
. Grab this project with `git clone git@github.com:gregturn/asciidoc-packt.git`
. Install http://asciidoctor.org with gem install asciidoctor
. Install a few gems: gem install thread_safe tilt
. Install one more just for fun: gem install slim --version 2.1.0
